...
Podemos ver que a pesar de ser tweets "de juego", sigue estando el tema político de fondo, estando los términos "trump" y "hillary" muy presentes, además de hashtags evidentemente políticos, como "obamaswishlist".

También vemos que aparecen números o contracciones en estos términos, así que, para obtener términos más representativos, vamos a hacer nuestras propias stopwords.
...
Vemos los 100 términos más repetidos, tanto si son hashtags como si no.
...
Lo primero, @midnight, que es el término que más se repite... @midnight es un "late night show" cómico, en ComedyCentral. Seguramente, fuera el que empezaría esto de poner tweets con un hashtag y seguir la broma.
...
Guardamos el diagrama como una imagen en local.
...
Y es así. "WorldOfHashtags" es una cuenta creada por "Internet Research Agency", una compañía rusa que actúa en representación del gobierno ruso. Curiosamente, esta cuenta solo estuvo activa desde el 22 de Abril de 2015 al 17 de Abril de 2017, coincidiendo de lleno con las elecciones estadounidenses del 2016. 
...
Los enlaces muestran no solo cuando se creó y cerró la cuenta falsa, sino la frecuencia de tweets en función del tiempo y la región donde se llevó a cabo las publicaciones de los tweets.
...
Vemos aquí los usuarios menos activos de "Hashtag Games". Estos números sí se pueden corresponder a personas normales que no fuesen bots.
...
Nos quedamos con las menciones. En twitter, si quieres mencionar a otro usuario, se hace mediante la fórmula @ + nombreDeUsuario.
...
Borramos aquellos usuarios NA. Es decir, borramos aquello donde no se mencionase a nadie, pues quiero ver relaciones entre autores de tweets y mencionados.
...
Vemos que el grado de "WorldOfHashtags" es muy elevado
...
Vamos a hacer este mismo grafo, pero ahora con solo un hashtag, el que más se repetía, "#ToDoListBeforeChristmas".
